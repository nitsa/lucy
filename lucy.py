...
def help():
    ...
    print ('\nOptions')
    print ('-s : download as text file and print to screen')
    print ('-d : download as binary file and save')
    print ('-m : download multiple files and save')
    print ('\nInput')
    print ('File with filepath(s) to scan or single filepath')
    print ('\nExamples')
